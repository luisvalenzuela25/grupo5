...
# Conclusión:
El circuito fue probado utilizando un multitester (multímetro), y los valores medidos fueron muy cercanos a los calculados el avlor fue de unos 184.10 Ω , confirmando que el circuito está correctamente diseñado y las resistencias están funcionando como se esperaba.
